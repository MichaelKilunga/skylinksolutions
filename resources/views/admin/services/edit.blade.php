    ...
    <form method="POST" action="{{ route('admin.services.update', $service) }}">
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="text" id="icon" name="icon" class="form-control" value="{{ old('icon', $service->icon) }}" oninput="updatePreview(this.value)">
                <div class="form-hint">Font Awesome class e.g. <code style="color:#a78bfa;">fa-network-wired</code></div>
                <div class="icon-preview">
                    <div class="preview-box" id="iconPreview"><i class="fas {{ $service->icon }}" id="previewIcon"></i></div>
        ...
        <div class="form-group">
            ...
            <div class="toggle-row">
                <label class="toggle-switch">
                    <input type="checkbox" name="is_active" {{ old('is_active', $service->is_active) ? 'checked' : '' }}>
...
function updatePreview(val) {
    document.getElementById('previewIcon').className = 'fas ' + (val || 'fa-cogs');
}
</script>
@endpush
