    ...
    <table class="datatable">
        ...
        <tbody>
            ...
            <tr class="{{ !$ptr->is_active ? 'inactive' : '' }}">
                <td><img src="{{ $ptr->logo_url }}" alt="{{ $ptr->name }}" style="width: 60px; height: 36px; object-fit: contain; background: #fff; border-radius: 4px; padding: 2px;"></td>
                <td><div style="font-weight:700; color: var(--text);">{{ $ptr->name }}</div></td>
