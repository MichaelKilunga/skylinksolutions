...
@section('title', 'Edit Project Link')
@section('page-title', 'Edit Project Link')
...
<div class="form-card">
    <form action="{{ route('admin.projects.update', $project) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" id="name" class="form-control" placeholder="e.g. PILLPOINTONE" value="{{ old('name', $project->name) }}" required>
            @error('name') <span class="error-msg">{{ $message }}</span> @enderror
        </div>

        <div class="form-group">
            <label for="url">Project URL</label>
            <input type="url" name="url" id="url" class="form-control" placeholder="https://example.com" value="{{ old('url', $project->url) }}" required>
        ...
        <div class="row" style="display:flex; gap:20px;">
            <div class="form-group" style="flex:1;">
                ...
                <input type="number" name="order" id="order" class="form-control" placeholder="0" value="{{ old('order', $project->order) }}">
            ...
            <div class="form-group" style="flex:1;">
                ...
                <div style="display:flex; align-items:center; gap:10px; margin-top:8px;">
                    <label class="switch">
                        <input type="checkbox" name="is_active" {{ $project->is_active ? 'checked' : '' }} value="1">
        ...
        <div style="margin-top:30px; display:flex; gap:12px;">
            <button type="submit" class="btn-save">Update Project Link</button>
