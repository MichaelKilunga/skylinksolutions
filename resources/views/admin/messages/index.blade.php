...
@push('styles')
    <style>
        ...
        tbody tr.unread td:first-child {
                    ...
                    @foreach ($messages as $msg)
                        <tr class="{{ !$msg->is_read ? 'unread' : '' }}">
                            ...
                            <td>
                                ...
                                @else
                                    <span class="status-badge status-unread"><i class="fas fa-circle"
                                            style="font-size:7px;"></i> Unread</span>
                                @endif
                            </td>
                            <td>{{ $msg->created_at->format('M d, Y') }}<br><span
                                    style="font-size:11px;color:#64748b;">{{ $msg->created_at->format('h:i A') }}</span>
                            </td>
                            <td>
                                <div class="action-btns">
                                    <a href="{{ route('admin.messages.show', $msg) }}" class="btn-view"><i
