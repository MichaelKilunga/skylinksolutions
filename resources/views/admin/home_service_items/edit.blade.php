    ...
    <div class="panel-body">
        <form action="{{ route('admin.home_service_items.update', $homeServiceItem) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group" style="margin-bottom: 20px;">
                ...
                <input type="text" name="title" class="form-control" style="width: 100%; padding: 12px; background: rgba(255,255,255,0.05); border: 1px solid var(--border); border-radius: 8px; color: #fff;" value="{{ $homeServiceItem->title }}" required>
            </div>

            <div class="form-group" style="margin-bottom: 20px;">
                <label style="display: block; font-size: 13px; color: var(--text-muted); margin-bottom: 8px;">Description</label>
                <textarea name="description" rows="3" class="form-control" style="width: 100%; padding: 12px; background: rgba(255,255,255,0.05); border: 1px solid var(--border); border-radius: 8px; color: #fff;">{{ $homeServiceItem->description }}</textarea>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group" style="margin-bottom: 20px;">
                        ...
                        <div style="margin-bottom: 10px;">
                            <img src="{{ asset($homeServiceItem->image) }}" style="width: 100px; height: 100px; object-fit: cover; border-radius: 8px; border: 1px solid var(--border);">
                        </div>
                ...
                <div class="col-md-6">
                    <div class="form-group" style="margin-bottom: 20px;">
                        ...
                        <input type="number" name="order" class="form-control" style="width: 100%; padding: 12px; background: rgba(255,255,255,0.05); border: 1px solid var(--border); border-radius: 8px; color: #fff;" value="{{ $homeServiceItem->order }}">
                    </div>
                </div>
            </div>
