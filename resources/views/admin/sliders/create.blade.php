...
<div class="page-header">
    <h2 style="font-size:20px;font-weight:700;color:var(--text); margin: 0;">
        <i class="fas fa-plus-circle" style="color:#10b981;margin-right:10px;"></i>Create New Slider
    </h2>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="btn1_text" class="form-control" placeholder="e.g. Get Started">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label class="form-label">Primary Button URL</label>
                    <input type="text" name="btn1_url" class="form-control" placeholder="e.g. /contact">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label class="form-label">Secondary Button Text</label>
                    <input type="text" name="btn2_text" class="form-control" placeholder="e.g. Learn More">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label class="form-label">Secondary Button URL</label>
                    <input type="text" name="btn2_url" class="form-control" placeholder="e.g. /about">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <small style="color: #64748b; font-size: 12px; margin-top: 6px; display: block;">Required. Recommended size: 1920x1080px.</small>
                </div>
            </div>
        </div>
