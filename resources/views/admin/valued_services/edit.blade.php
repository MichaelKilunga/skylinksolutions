            ...
            <div class="row">
                ...
                <div class="col-12 mb-4">
                    ...
                    <textarea name="description" rows="4" class="form-control"
                        style="background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); color: #fff; border-radius: 8px; padding: 12px;">{{ $valuedService->description }}</textarea>
                </div>
                <div class="col-12 mb-4">
