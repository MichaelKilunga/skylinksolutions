...
<div class="form-container">
    <form action="{{ route('admin.news.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" name="title" id="title" class="form-control" placeholder="Enter a catchy title" value="{{ old('title') }}" required>
        ...
        <div class="grid-2">
            <div class="form-group">
                ...
                <input type="text" name="category" id="category" class="form-control" placeholder="e.g. System Update, Company" value="{{ old('category') }}">
            </div>
            <div class="form-group">
                <label for="author_name">Author Name</label>
                <input type="text" name="author_name" id="author_name" class="form-control" placeholder="e.g. Michael Kilunga" value="{{ old('author_name', 'SkyLink Team') }}">
            </div>
        </div>

        <div class="form-group">
            <label for="excerpt">Excerpt (Short Summary)</label>
            <textarea name="excerpt" id="excerpt" class="form-control" placeholder="A brief summary for the news grid">{{ old('excerpt') }}</textarea>
        </div>

        <div class="form-group">
            <label for="content">Full Content</label>
            <textarea name="content" id="content" class="form-control" placeholder="The full story goes here..." style="min-height:250px;">{{ old('content') }}</textarea>
        </div>
            ...
            <div class="form-group">
                ...
                <div class="file-input-wrapper">
                    <label for="image" class="file-input-label">
                        <i class="fas fa-image"></i> <span>Upload News Image</span>
                    </label>
                    <input type="file" name="image" id="image">
                    <small class="text-muted mt-2 d-block"><strong>Max 1MB.</strong></small>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="file-input-wrapper">
                    <label for="author_image" class="file-input-label">
                        <i class="fas fa-user-circle"></i> <span>Upload Author Image</span>
                    </label>
        ...
        <div class="form-group checkbox-group">
            ...
            <label for="is_published" style="margin-bottom:0;">Publish immediately</label>
        </div>
