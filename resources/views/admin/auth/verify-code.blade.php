...
<head>
    ...
    <title>Verify Code — {{ $company_setting->company_name ?? 'SkyLink Solutions' }}</title>
    ...
    <div class="login-container">
        ...
        <div class="login-panel">
            ...
            <div class="login-heading">
                <p>Enter the 6-digit code sent to <strong>{{ $email }}</strong>. Expires in 30 minutes.</p>
            </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <input type="text" id="code" name="code" class="form-input"
                               ...
                               style="padding-left: 44px; font-size: 16px; font-weight: 600;">
