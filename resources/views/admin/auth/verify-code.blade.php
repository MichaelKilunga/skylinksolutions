...
<head>
    ...
    <title>Verify Code — SkyLink Solutions</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .login-heading p  { font-size: 14px; color: #94a3b8; margin-bottom: 32px; line-height: 1.5; }
        ...
        .form-input::placeholder { color: #475569; letter-spacing: normal; }

        .error-box { background: rgba(239,68,68,0.1); border: 1px solid rgba(239,68,68,0.3); border-radius: 10px; padding: 12px 16px; margin-bottom: 24px; font-size: 13px; color: #fca5a5; display: flex; align-items: center; gap: 10px; }
        .success-box { background: rgba(34,197,94,0.1); border: 1px solid rgba(34,197,94,0.3); border-radius: 10px; padding: 12px 16px; margin-bottom: 24px; font-size: 13px; color: #86efac; display: flex; align-items: center; gap: 10px; }
        ...
        .btn-submit:hover { transform: translateY(-2px); box-shadow: 0 8px 25px rgba(59,130,246,0.5); background: linear-gradient(135deg, #60a5fa, #3b82f6); }
    ...
    <div class="login-wrapper">
        <div class="login-card">
            ...
            <div class="login-heading">
                <h2>Verify Code</h2>
                <p>Please enter the 6-digit code sent to <strong>{{ $email }}</strong>. The code expires in 30 minutes.</p>
            </div>
            ...
            <form method="POST" action="{{ route('admin.password.verify.post') }}">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" id="code" name="code" class="form-input"
                               ...
                               value="{{ old('code') }}" required autofocus autocomplete="one-time-code">
                    </div>
                </div>

                <button type="submit" class="btn-submit">
                    <i class="fas fa-check-double" style="margin-right:8px;"></i>Verify Code
                </button>
            </form>

            <div class="login-footer">
                <a href="{{ route('admin.password.request') }}"><i class="fas fa-arrow-left" style="margin-right:4px;"></i>Resend code</a>
            </div>
        </div>
    </div>
</body>
