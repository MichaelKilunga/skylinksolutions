...
<head>
    ...
    <title>Forgot Password — {{ $company_setting->company_name ?? 'SkyLink Solutions' }}</title>
    ...
    <div class="login-container">
        ...
        <div class="login-panel">
            ...
            <div class="login-heading">
                <p>Just let us know your email address and we will email you a 6-digit verification code.</p>
            </div>
            ...
            <div class="login-footer">
                <a href="{{ route('admin.login') }}"><i class="fas fa-arrow-left" style="margin-right:4px;"></i> Back to
                    login</a>
            </div>
        </div>
    </div>
