...
<head>
    ...
    <title>Forgot Password — SkyLink Solutions</title>
    ...
    <div class="login-wrapper">
        <div class="login-card">
            ...
            <div class="login-heading">
                ...
                <p>No problem. Just let us know your email address and we will email you a 6-digit verification code to reset your password.</p>
            </div>
            ...
            <div class="login-footer">
                <a href="{{ route('admin.login') }}"><i class="fas fa-arrow-left" style="margin-right:4px;"></i>Back to login</a>
            </div>
        </div>
    </div>
</body>
