...
<head>
    ...
    <title>Reset Password — {{ $company_setting->company_name ?? 'SkyLink Solutions' }}</title>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <input type="email" id="email" name="email" class="form-input"
                               ...
                               style="padding-left: 44px; background-color: #e9ecef; color: #6c757d; border: 1px solid #ced4da; cursor: not-allowed;">
